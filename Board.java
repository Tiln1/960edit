...
class Board implements ActionListener,Serializable{ 
    ...
    ArrayList<Integer> forMirroring = new ArrayList<Integer>();
    Board() {
    ...
    public void initialiseBoard(boolean nine60){
        ...
        //initialising pieces
        if(nine60){
        	initialiseWhitePieces2();
        	initialiseBlackPieces2();}
        else {
...
//		boardFrame.getRootPane().setWindowDecorationStyle(JRootPane.NONE);
    ...
    public void initialiseWhitePieces2(){
        whitePieceRef = new ArrayList<Piece>();
        for(int i=1;i<9;i++){
            Pawn p = new Pawn(7,i,0);
            squares[7][i].addPiece(p);
        ...
        int king = (int)(Math.random()*6)+2;
        forMirroring.add(arr.remove(arr.indexOf(king)));
        w0 = new King(8,king,0);
        whitePieceRef.add(w0);
		squares[8][king].addPiece(w0);
		
		int rand = (int)(Math.random()*(king-1))+1;
		forMirroring.add(arr.remove(arr.indexOf(rand)));
		Rook p4 = new Rook(8,rand,0);
		squares[8][rand].addPiece(p4);
        whitePieceRef.add(p4);
        
        rand = (int)(Math.random()*(7-king))+king+1;
        forMirroring.add(arr.remove(arr.indexOf(rand)));
		Rook p5 = new Rook(8,rand,0);
		squares[8][rand].addPiece(p5);
        whitePieceRef.add(p5);
        ...
        forMirroring.add(arr.remove(arr.indexOf(rand)));
        Bishop p2 = new Bishop(8,rand,0);
		squares[8][rand].addPiece(p2);
        whitePieceRef.add(p2);
        ...
        forMirroring.add(arr.remove(arr.indexOf(rand)));
		Bishop p3 = new Bishop(8,rand,0);
		squares[8][rand].addPiece(p3);
        whitePieceRef.add(p3);
        
        rand = arr.get((int)(Math.random()*(arr.size())-1));
        forMirroring.add(arr.remove(arr.indexOf(rand)));
		Queen p1 = new Queen(8,rand,0);
		squares[8][rand].addPiece(p1);
        whitePieceRef.add(p1);
        
        rand = arr.get((int)(Math.random()*(arr.size())-1));
        forMirroring.add(arr.remove(arr.indexOf(rand)));
		Knight p6 = new Knight(8,rand,0);
		squares[8][rand].addPiece(p6);
        whitePieceRef.add(p6);
        
        rand = arr.get((int)(Math.random()*(arr.size())-1));
        forMirroring.add(arr.remove(arr.indexOf(rand)));
		Knight p7 = new Knight(8,rand,0);
		squares[8][rand].addPiece(p7);
        whitePieceRef.add(p7);
    }
    ...
    public void initialiseBlackPieces2(){
        int i=1;
        blackPieceRef = new ArrayList<Piece>();
        for(i=1;i<9;i++){
            Pawn p=new Pawn(2,i,1);
        ...
        b0 = new King(1,forMirroring.get(0),1);
		squares[1][forMirroring.get(0)].addPiece(b0);
        blackPieceRef.add(b0);
        
        Rook p4 = new Rook(1,forMirroring.get(1),1);
		squares[1][forMirroring.get(1)].addPiece(p4);
        blackPieceRef.add(p4);
        
		Rook p5 = new Rook(1,forMirroring.get(2),1);
		squares[1][forMirroring.get(2)].addPiece(p5);
        blackPieceRef.add(p5);
        
		Bishop p2 = new Bishop(1,forMirroring.get(3),1);
		squares[1][forMirroring.get(3)].addPiece(p2);
        blackPieceRef.add(p2);
        
		Bishop p3 = new Bishop(1,forMirroring.get(4),1);
		squares[1][forMirroring.get(4)].addPiece(p3);
        blackPieceRef.add(p3);
        
        Queen p1 = new Queen(1,forMirroring.get(5),1);
		squares[1][forMirroring.get(5)].addPiece(p1);
        blackPieceRef.add(p1);
        
		Knight p6 = new Knight(1,forMirroring.get(6),1);
		squares[1][forMirroring.get(6)].addPiece(p6);
        blackPieceRef.add(p6);
        
		Knight p7 = new Knight(1,forMirroring.get(7),1);
		squares[1][forMirroring.get(7)].addPiece(p7);
        blackPieceRef.add(p7);
    }
	...
	public void setPlayerDetailsShowBoard(String playerOneName, String playerTwoName, int timeLimit, boolean nine60){
		player1.setText(playerOneName);
		player2.setText(playerTwoName);
		initialiseBoard(nine60);
