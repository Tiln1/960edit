...
class MenuListener implements ActionListener,Serializable{
   private Board board;
    ...
    public void beginNextGame(){
        ...
        //PlayerNames playerNames = new PlayerNames(board);
        board.boardReset();
        board.setPlayerDetailsShowBoard(board.getPlayer2Name(),board.getPlayer1Name(), board.getTimeLimit(), false);
    }
    ...
    public void loadBoard(Board loadBoard){
      int i,j;
        ...
        board.setPlayerDetailsShowBoard(loadBoard.getPlayer1Name(),loadBoard.getPlayer2Name(), loadBoard.getTimeLimit(), false);
